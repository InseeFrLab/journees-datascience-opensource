...
.card h4 { margin: 0 0 0.3rem; color: #1b3a5b; font-size: 1.5rem; }
.card p { margin: 0; font-size: 1.2rem; color: #475569; }
</style>
```
## Pourquoi ce sprint ? {.small}
...
## Ce dont vous avez besoin {.small}
